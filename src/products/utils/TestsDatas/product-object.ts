import { Brand, Style } from '@prisma/client';

export const productObjectData = {
  ...
  categories: ['Vetements', 'Femme', 'TeeShirt'],
  price: 12,
  size: ['S', 'M', 'L'],
  quantity_available: {
    XXS: 1,
...
export const productObjectExpected = {
  title: 'T-shirt col tunisien manches courtes ',
  ref: '3743981 / GJY899',
  color: ['white', 'black', 'red'],
  description:
  ...
  size: ['S', 'M', 'L'],
  quantity_available: {
    create: { XXS: 1, XS: 3, S: 2, M: 4, L: 5, XL: 1, XXL: 6, XXXL: 7 },
  },
  pictures: {
    createMany: {
      data: [
